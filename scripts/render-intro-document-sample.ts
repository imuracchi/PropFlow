...
.stage{width:900px;height:900px;display:flex;align-items:center;justify-content:center;padding:26px;background:linear-gradient(135deg,#eef2f6,#dce4ec)}
.page{width:600px;height:848px;background:#fff;padding:36px 42px;box-shadow:0 18px 45px rgba(15,38,65,.2);font-size:9px;line-height:1.5}

...
.stage{width:1200px;height:900px;display:flex;align-items:center;justify-content:center;padding:34px;background:linear-gradient(135deg,#eef2f6,#dce4ec)}
.page{width:560px;height:792px;background:#fff;padding:34px 40px;box-shadow:0 18px 45px rgba(15,38,65,.2);font-size:9px;line-height:1.5}
...
.side{width:390px;margin-left:36px}.side h2{margin:0;color:#173f70;font-size:30px;line-height:1.4}.side p{font-size:16px;line-height:1.8;color:#526176}.badge{display:inline-block;background:#eaf1ff;color:#2563eb;padding:7px 14px;border-radius:99px;font-size:13px;font-weight:700;margin-bottom:16px}.points{display:grid;gap:10px}.point{background:#fff;border-left:4px solid #2b5c94;padding:12px 14px;font-size:14px;font-weight:700;color:#263b58}
</style></head><body><div class="stage"><div class="page">
...
<div class="ft">株式会社サンプル不動産 - 物件紹介資料</div></div>
<div class="side"><span class="badge">実際の出力デザイン</span><h2>自社の名前で、<br>すぐに紹介できる。</h2><p>物件情報から、PropFlowの実際のレイアウトで紹介資料を自動生成します。</p><div class="points"><div class="point">会社名・ロゴ・連絡先を反映</div><div class="point">物件概要を見やすい表で整理</div><div class="point">地図・現地写真・交通アクセスも選択可能</div></div></div>

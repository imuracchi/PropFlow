...
export function buildPublicPropertyDocumentHtml(property: PublicPropertyDocumentData, inquiryUrl: string) {
  ...
  const rows: Array<[string, string, string, string]> = [
    ...
    ["交通", valueOrDash(property.transport), "用途地域", valueOrDash(property.zoning)],
  ];
  return `<!doctype html><html lang="ja"><head><meta charset="utf-8"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;600;700&display=block" rel="stylesheet"><style>

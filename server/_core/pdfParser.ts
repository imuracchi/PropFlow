...
- transport: 交通（最寄り駅・徒歩分数。例: 「東京メトロ銀座線「外苑前」駅 徒歩7分」。なければnull）
- landCategory: 地目（宅地/田/畑/山林等。なければnull）
- rights: 権利（所有権/借地権等。なければnull）
- structure: 構造（RC造/木造等。なければnull）
- buildingAge: 築年数（例: 「築15年」。なければnull）
- zoning: 用途地域（例: 「第一種中高層住居専用地域」。なければnull）
- fireProtection: 防火指定（準防火地域/防火地域等。なければnull）
- access: 接道条件（例: 「南側公道 幅員4.00m」。なければnull）
- negotiation: 価格交渉（「固定」 or 「交渉可」。不明なら「固定」）
- comment: 紹介コメント（物件の特徴・立地・参考情報を2〜3文で要約生成）
- heightDistrict: 高度地区（なければnull）
- otherRestrictions: その他制限（日影規制等。なければnull）
- remarks: 備考（なければnull）

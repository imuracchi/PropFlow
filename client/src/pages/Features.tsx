...
const sections = [
  {
    ...
    items: [
      "登録されている物件を一覧で見られます",
      "エリア・価格・種別・土地面積・価格交渉で絞り込めます",
      "列ヘッダーをクリックして並び替え（ソート）ができます",
  ...
  },
  {
    ...
    items: [
      ...
      "アップロードした資料は1件ずつ「全員に公開」「登録者のみ」を選択可能。他社のロゴ・会社情報が入った資料はその場で非公開にできます",
  ...
  },
  {
    ...
    items: [
      ...
      "代理登録：専用フォームから名刺画像を送って登録を依頼できます",
    ],
  },
  {
    title: "スマホでも使えます",
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      ...
      <div className="bg-primary/5 border border-primary/15 rounded-lg px-4 py-3 text-center">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">今後、より便利にご利用いただくための一部機能について有料プランを導入する場合がございます。</p>
      </div>
      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden">
        <div className="px-5 py-3 bg-muted/40 flex items-center gap-3">
          ...
          <h3 className="text-sm font-semibold text-foreground">PropFlowをスマホのホーム画面に追加</h3>
        </div>
        <div className="px-5 py-3">
          <p className="text-xs text-muted-foreground">アプリのように使え、プッシュ通知も受け取れます。マイページにiPhone・Androidそれぞれの追加方法が案内されています。</p>
        </div>
      </div>

      <div className="bg-card border border-border rounded-lg overflow-hidden">
        <div className="px-5 py-3 bg-muted/40 flex items-center gap-3">
          <div className="w-5 h-5 bg-[#06C755] rounded flex items-center justify-center shrink-0">
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-white fill-current"><path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.627-.63h2.386c.349 0 .63.285.63.63 0 .349-.281.63-.63.63H17.61v1.125h1.755zm-3.855 3.016c0 .27-.174.51-.432.596-.064.021-.133.031-.199.031-.211 0-.391-.09-.51-.25l-2.443-3.317v2.94c0 .344-.279.629-.631.629-.346 0-.626-.285-.626-.629V8.108c0-.27.173-.51.43-.595.06-.023.136-.033.194-.033.195 0 .375.104.495.254l2.462 3.33V8.108c0-.345.282-.63.63-.63.345 0 .63.285.63.63v4.771zm-5.741 0c0 .344-.282.629-.631.629-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.627-.63.349 0 .631.285.631.63v4.771zm-2.466.629H4.917c-.345 0-.63-.285-.63-.629V8.108c0-.345.285-.63.63-.63.348 0 .63.285.63.63v4.141h1.756c.348 0 .629.283.629.63 0 .344-.282.629-.629.629M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608.391.082.923.258 1.058.59.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645 1.291-.539 6.916-4.078 9.436-6.975C23.176 14.393 24 12.458 24 10.314"/></svg>
          </div>
          <h3 className="text-sm font-semibold text-foreground">LINEで新着物件の通知を受け取る</h3>
        </div>
        <div className="px-5 py-3">
          <p className="text-xs text-muted-foreground">PropFlowの公式LINEを友だち追加すると、新しい物件が登録されたときにLINEで通知が届きます。マイページから友だち追加できます。</p>
        </div>
      </div>
    </div>
  );
